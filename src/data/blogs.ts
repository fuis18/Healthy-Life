export const blogs = [
	{
		id: "por-que-ofrecemos-mermelada-de-frutos-rojos",
		title: `¿Por qué ofrecemos mermelada de frutos rojos como acompañante de nuestros
		postres?`,
		image: "/page-blog-1.webp",
	...
	{
		id: "brownie-de-palta-nutricion-y-sabor",
		title: `Brownie de Palta: nutrición y sabor en un solo postre`,
		image: "/page-blog-3.webp",
		author: "Miguel Forfui",
		...
		content: [
			...
			{
				type: "l",
				content: "Preparado con ingredientes naturales y sin conservantes",
			},
			{
				type: "l",
